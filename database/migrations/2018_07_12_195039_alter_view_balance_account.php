...
class AlterViewBalanceAccount extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("
            CREATE OR REPLACE VIEW expense_account AS
              ...
              WHERE (e.date_operation < now() or e.date_operation ISNULL) AND e.deleted_at = NULL
        ...
        DB::statement("
            create OR REPLACE view profit_account as
              ...
              WHERE (p.date_operation < now() or p.date_operation ISNULL) AND p.deleted_at = NULL
