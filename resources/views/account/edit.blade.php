            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            {!! BootForm::open(['url' => url("/account/".$account->id), 'method' => 'post']) !!}
                            ...
                            {!! BootForm::number('operation', 'Operação', $account->operation) !!}
                            {!! BootForm::number('account', 'Conta', $account->account) !!}
                            {!! BootForm::number('agency', 'Agencia', $account->agency) !!}
                            {!! BootForm::submit('Editar Conta', ['class' => 'btn btn-primary']) !!}
